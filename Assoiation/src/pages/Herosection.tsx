    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center py-12 md:py-20 mt-[90px] md:mt-[70px] ">
        ...
        <div 
          ...
          className={`inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-2.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 mb-6 md:mb-8 shadow-2xl max-w-full transition-all duration-1000 ${
        ...
        <h1 
          ...
          className={`text-base sm:text-xl md:text-3xl lg:text-4xl font-bold text-white max-w-6xl mx-auto leading-[1.3] md:leading-[1.2] mb-6 tracking-tight drop-shadow-sm px-2 transition-all duration-1000 delay-150 ${
        ...
        <p 
          ...
          className={`max-w-xl md:max-w-3xl lg:max-w-3xl mx-auto text-xs sm:text-[14px] lg:text-[15px] text-center xl:text-center xl:text-[17px] text-slate-200 font-light leading-relaxed mb-8 md:mb-10 px-4 md:px-5 lg:px-[20px] font-semibold transition-all duration-1000 delay-300 ${
        ...
        >
          <a 
            href="/#contact" 
            className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-sm md:text-base font-bold transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.5)] hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2 group"
          >
            CONTACT US
